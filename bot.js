...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`bearmusic Bot- Script By : bearboy`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : bearboy ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`<o/play + music`,"http://twitch.tv/Death Shop")
